...
// JQU: Merged with         "Creality/Ender-3 Pro"
...
//#define LIN_ADVANCE
  ...
  #define LIN_ADVANCE_K 0.00    // Unit: mm compression per 1mm/s extruder speed // JQU: Teaching Tech has 0.11 here. Could run the test later.
